<!DOCTYPE html>
<html>
    <head><h1><meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title> Registration Page</title></h1>
    ...
    <table align='center'>
        <td>
            <fieldset>
                ...
                <form action="registrations.php" method="post" novalidate>
      ...
      <label for="faname">Father's Name:</label>
       ...
       <input type="text" id="maname" name="maname"><br><br>
       <label for="dob">date of Birth:</label>
        ...
        <label for="bg">Blood Group</label><select id="bg" name="bg"><br> 
             ...
             <option value="B+">B+</option></select><br><br>
                ...
                <label for="website">Website:</label>
                 ...
                 <textarea id="pa" name="pa" rows="4" cols="50"></textarea>
                </fieldset >
